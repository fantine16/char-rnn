...
cmd:text('Options')
-- data
cmd:option('-data_dir','data/harrypotter_all','data directory. Should contain the file input.txt with input data')
-- model params
...
cmd:option('-checkpoint_dir', 'harry_all_model', 'output directory where checkpoints get written')
